...
void AHorrorCharacter::BeginPlay()
{
	...
	GetWorldTimerManager().SetTimer(TimerHandle_Interaction, this, &AHorrorCharacter::PerformInteractionCheck, 0.1f, true);
}
...
void AHorrorCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...

	{
		...
		if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
		{
			...
			// Interaction
			EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Started, this, &AHorrorCharacter::Interact);
		}
	}
}
